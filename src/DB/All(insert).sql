...
CREATE TABLE RVCOMMENT(
   ...
   CONSTRAINT RVCOMMENT_FK_MEMBER_ID FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER(MEMBER_ID) ON DELETE CASCADE,
   CONSTRAINT RVCOMMENT_FK_RV_ID FOREIGN KEY(RV_ID) REFERENCES RVDOCUMENT(RV_ID) ON DELETE CASCADE
);
