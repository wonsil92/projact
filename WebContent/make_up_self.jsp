...
<script src="js/form_builder.js?ver=5"></script>
...
window.onload = function() {
	...
	$(".dropdown-menu").append("<a class=\"dropdown-item\" href='javascript:void(0);' onclick='callchk(\""+document.getElementsByName("contentValue")[1].value+"\"); return false'>"+document.getElementsByName("contentValue")[1].value+"</a>");
	}
	if(document.getElementsByName("contentValue")[2].value !=""){
		$(".dropdown-menu").append("<a class=\"dropdown-item\" href='javascript:void(0);' onclick='callchk(\""+document.getElementsByName("contentValue")[2].value+"\"); return false'>"+document.getElementsByName("contentValue")[2].value+"</a>");
		}
	if(document.getElementsByName("contentValue")[3].value !=""){
		$(".dropdown-menu").append("<a class=\"dropdown-item\" href='javascript:void(0);' onclick='callchk(\""+document.getElementsByName("contentValue")[3].value+"\"); return false'>"+document.getElementsByName("contentValue")[3].value+"</a>");
		}
	if(document.getElementsByName("contentValue")[4].value !=""){
		$(".dropdown-menu").append("<a class=\"dropdown-item\" href='javascript:void(0);' onclick='callchk(\""+document.getElementsByName("contentValue")[4].value+"\"); return false'>"+document.getElementsByName("contentValue")[4].value+"</a>");
		}
	if(document.getElementsByName("contentValue")[5].value !=""){
		$(".dropdown-menu").append("<a class=\"dropdown-item\" href='javascript:void(0);' onclick='callchk(\""+document.getElementsByName("contentValue")[5].value+"\"); return false'>"+document.getElementsByName("contentValue")[5].value+"</a>");
		}
}
//임시저장(쿠키) 함수
	function storechk(){
...
<%-- <%@ include file="inc/kangilexe.jsp"%> --%>
